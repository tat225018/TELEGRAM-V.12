...
# -----------------------------------------------------------------------
m_main = Menu("Главное меню", buttons=["Развлечения", "Игры", "ДЗ", "Пользователи"])
...
m_fun = Menu("Развлечения", buttons=["Пришли собачку 🐶", "Пришли котика ^^ meow", "Прислать лису", "Прислать анекдот", "Прислать фильм", "Угадай кто?", "Выход"], parent=m_main, module="fun")
